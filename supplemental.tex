...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{figures/supp_old_new_comparison2}
\caption{The distributions of mean squared error (MSE) for the results from the proposed method with and without information on the secondary structures, and an older method without explicit peak-matching, respectively, over the 95 data sets. MSE units are normalized so that average distance between band locations is unity. The mean and median MSE for the proposed method with the knowledge of secondary structures (mean: 0.796, median: 0.198) are clearly lower than those for the proposed method without secondary structures (mean: 0.891, median: 0.357) and for the older method (mean: 1.164, median: 0.327). The proposed method was also carried out for individual profiles separately, in an effort to assess the contribution of the use of multiple profile to the quality of the band annotation; without taking multiple profiles together as input, the proposed method returned relatively inferior outcome (mean: 0.973, median: 0.257), showing the benefit of taking into account multiple profiles.}
\label{f:old_vs_new}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
