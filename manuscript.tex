...
\newcommand{\hilightcolor}{black} % turn off highlights for the previous revision

\newcommand{\hilight}[1]{{\color{\hilightcolor}#1}} % major revision
\newcommand{\hilightb}[1]{{\color{\hilightcolor}#1}} % major revision
\newcommand{\hilightr}[1]{{\color{red}#1}} % minor revision
%\newcommand{\hilightr}[1]{{\color{black}#1}} % minor revision
